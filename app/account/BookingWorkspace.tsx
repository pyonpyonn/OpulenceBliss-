  ...
  return (
    <div className="booking-workspace">
      <section className="booking-card">
        ...
        <div className="summary-grid">
          ...
          >
            ...
            {booking.provider.yearsExperience !== null && (
              <small>
                <ShieldCheck size={14} /> {booking.provider.yearsExperience}+
                years experience
              </small>
            )}
          </SummaryCard>
        ...
        <section className={`status-banner ${visitStatus?.tone ?? "neutral"}`}>
          <CheckCircle2 size={29} />
          <div>
            <strong>
              {visitStatus?.headline ?? "Your booking is confirmed"}
            </strong>
            <p>{visitStatus?.detail ?? "We will keep you updated here."}</p>
          </div>
          {canCancel && (
