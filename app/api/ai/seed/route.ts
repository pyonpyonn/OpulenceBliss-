...
const DOCS: { title: string; content: string }[] = [
  ...
  },
  {
    ...
    content:
      "You can reschedule or cancel any individual visit from /account up to 48 hours before it's due, and your card isn't charged for a cancelled visit. To pause your membership or cancel it after the three-month minimum term, contact the Opulence Bliss team and they'll arrange it.",
  },
  {
